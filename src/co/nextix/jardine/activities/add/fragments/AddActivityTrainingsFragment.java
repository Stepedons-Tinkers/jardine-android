...
public class AddActivityTrainingsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View rootView = inflater.inflate(R.layout.add_activity_trainings,
				container, false);
		...
		// JardineApp.DB.getActivity().getById(activity_id);
		...
		// ((EditText)
		// rootView.findViewById(R.id.no_of_attendees)).setText(String.valueOf(numberOfAttendees));
		//
		// }
				...
				.setOnClickListener(new OnClickListener() {
					...
					public void onClick(final View v) {
						...
						if (((CircularProgressButton) v).getProgress() == 0) {
							...
							String venue = ((EditText) rootView
									.findViewById(R.id.venue)).getText()
									.toString();
							String noOfAttendess = ((EditText) rootView
									.findViewById(R.id.no_of_attendees))
									.getText().toString();

							Constant.activityGeneralInfo.setVenue(venue);
							Constant.activityGeneralInfo
									.setNumberOfAttendees(Tools
											.parseIntWithDefault(noOfAttendess,
													0));
							...
							if (venue != null && !venue.isEmpty()
									&& noOfAttendess != null
									&& !noOfAttendess.isEmpty()) {

								((EditText) rootView.findViewById(R.id.venue))
										.setError(null);
								((EditText) rootView
										.findViewById(R.id.no_of_attendees))
										.setError(null);
								...
								trapping = true;
								EditText noEditTxt = (EditText) rootView
										.findViewById(R.id.no_of_attendees);
								String notxt = noEditTxt.getText().toString();
								int noOfAttendees = Tools.parseIntWithDefault(
										notxt,
										Integer.parseInt(notxt.substring(0, 7)));
								...
								if (noOfAttendess == null
										|| noOfAttendess.isEmpty())
									((EditText) rootView
											.findViewById(R.id.no_of_attendees))
											.setError("Please provide no. of attendees.");
