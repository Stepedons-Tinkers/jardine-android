...
public class MarketingIntelCustomAdapterAdd extends BaseAdapter {
	...
	public MarketingIntelCustomAdapterAdd(Context a, FragmentActivity act, ListView listView, ArrayList<?> d, Fragment fragment) {
