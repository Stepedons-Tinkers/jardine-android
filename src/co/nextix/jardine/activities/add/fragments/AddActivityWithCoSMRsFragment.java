...
public class AddActivityWithCoSMRsFragment extends Fragment implements
		LocationListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ArrayAdapter<UserRecord> smrAdapter = new ArrayAdapter<UserRecord>(
				JardineApp.context, R.layout.add_activity_textview, userList);
		...
		this.saveBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(final View v) {
				...
				if (((CircularProgressButton) v).getProgress() == 0) {
					...
					Spinner smrSpinner = (Spinner) rootView
							.findViewById(R.id.smr);

					// /** Checking of required fields **/
					// final SharedPreferences pref = getActivity()
					// .getApplicationContext().getSharedPreferences(
					// "ActivityInfo", 0);
					String smrString = ((UserRecord) smrSpinner
							.getSelectedItem()).toString();
					if (smrString != null && !smrString.isEmpty()) {

						long smrId = ((UserRecord) smrSpinner.getSelectedItem())
								.getId();

						Constant.activityGeneralInfo.setSmr(smrId);

						// long smr = ((UserRecord) ((Spinner)
						// rootView.findViewById(R.id.smr)).getSelectedItem()).getId();
						//
						// flag = true;
						// new InsertTask("0", pref.getString("crm_no", null),
						// pref.getLong("activity_type", 0),
						// pref.getString("check_in",
						// null), pref.getString("check_out",
						// null).concat(displayCheckOut()),
						// pref.getLong("business_unit", 0),
						// StoreAccount.restore(getActivity()).getLong(Account.ROWID),
						// 123.894882, 10.310235, pref.getString(
						// "check_in", null), pref.getString("check_out",
						// null).concat(displayCheckOut()), " ", smr, "", 0, 0,
						// 0, 0, AddActivityFragment.WORKPLAN_ENTRY_ID, "", 0,
						// 0, "", "", "", "", "", 0, 0, "", 0, "").execute();
						//
	...
	//
	// private InsertTask(String no, String crmNo, long activityType, String
	// checkIn, String checkOut, long businessUnit, long createdBy,
	// double longitude, double latitude, String createdTime, String
	// modifiedTime, String reasonsRemarks, long smr,
	// String adminDetails, long customer, long area, long province, long city,
	// long workplanEntry, String objective,
	// int firstTimeVisit, int plannedVisit, String notes, String highlights,
	// String nextSteps, String followUpCommitmentDate,
	// String projectName, long projectStage, long projectCategory, String
	// venue, int numberOfAttendees,
	...
	// this.widthAnimation.setInterpolator(new
	// AccelerateDecelerateInterpolator());
	// this.widthAnimation.addUpdateListener(new
	...
	// try {
	//
	// saveActivity(this.no, this.crmNo, this.activityType, this.checkIn,
	// this.checkOut, this.businessUnit, this.createdBy,
	// this.longitude, this.latitude, this.createdTime, this.modifiedTime,
	// this.reasonsRemarks, this.smr,
	// this.adminDetails, this.customer, this.area, this.province, this.city,
	// this.workplanEntry, this.objective,
	// this.firstTimeVisit, this.plannedVisit, this.notes, this.highlights,
	// this.nextSteps, this.followUpCommitmentDate,
	// this.projectName, this.projectStage, this.projectCategory, this.venue,
	...
	// long createdBy, double longitude, double latitude, String createdTime,
	...
	// String nextSteps, String followUpCommitmentDate,
	// String projectName, long projectStage, long projectCategory, String
	// venue, int numberOfAttendees, String endUserActivityTypes) {
	//
	// // Insert to the database
	// JardineApp.DB.getActivity().insert(no, crmNo, activityType, checkIn,
	// checkOut, businessUnit, createdBy, longitude, latitude,
	// createdTime, modifiedTime, reasonsRemarks, smr, adminDetails, customer,
	// area, province, city, workplanEntry, objective,
	// firstTimeVisit, plannedVisit, notes, highlights, nextSteps,
	// followUpCommitmentDate, projectName, projectStage,
