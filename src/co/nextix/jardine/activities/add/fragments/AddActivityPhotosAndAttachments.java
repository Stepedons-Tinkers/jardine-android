					...
					if (title != null && !title.isEmpty() && filename != null && !filename.isEmpty()) {
						...
						if (pref.getString("details_marketing_intel", null) != null
							...
							new InsertTask("", "", pref.getLong("activity_type", 0), pref.getString("check_in", null), pref.getString(
									...
									null).concat(displayCheckOut()), "", 0, "", pref.getLong("customerlong", 0), pref.getLong("area", 0),
									pref.getLong("province", 0), pref.getLong("city_town", 0), pref.getLong("workplan_entry", 0), pref
											.getString("objective", null), pref.getInt("first_time_visit", 0), pref.getInt(
											"planned_time_visit", 0), pref.getString("notes", null), pref.getString("highlights", null),
							...
							new InsertTask("", "", pref.getString("first_name", null), pref.getString("last_name", null), pref.getLong(
									...
									.getString("email_address", null), pref.getLong("customerlong", 0), 1,
									pref.getString("check_in", null), pref.getString("check_out", null).concat(displayCheckOut()), pref
											.getLong("createdBy", pref.getLong("user_id", 0))).execute();
							...
							new InsertTask("", "", pref.getLong("activity_type", 0), pref.getString("check_in", null), pref.getString(
									...
									pref.getLong("province", 0), pref.getLong("city_town", 0), pref.getLong("workplan_entry", 0), pref
											.getString("objective", null), pref.getInt("first_time_visit", 0), pref.getInt(
											"planned_time_visit", 0), pref.getString("notes", null), pref.getString("highlights", null),
									pref.getString("next_steps", null), pref.getString("follow_up_committment_date", null), pref.getString(
											"project_name", null), pref.getLong("project_stage", 0), pref.getLong("project_category", 0),
									"", 0, "").execute();
							...
							new InsertTask("", "", pref.getLong("activity_type", 0), pref.getString("check_in", null), pref.getString(
									...
									pref.getLong("province", 0), pref.getLong("city_town", 0), pref.getLong("workplan_entry", 0), pref
											.getString("objective", null), pref.getInt("first_time_visit", 0), pref.getInt(
											"planned_time_visit", 0), pref.getString("notes", null), pref.getString("highlights", null),
									pref.getString("next_steps", null), pref.getString("follow_up_committment_date", null), "", 0, 0, pref
											.getString("trainings_venue", null), pref.getInt("trainings_no", 0), "").execute();
						...
						} else if (pref.getString("end_user_activity_types", null) != null
								&& !pref.getString("end_user_activity_types", null).isEmpty()) { // FullBranFocus
							...
							new InsertTask("", "", pref.getLong("activity_type", 0), pref.getString("check_in", null), pref.getString(
									...
									pref.getLong("province", 0), pref.getLong("city_town", 0), pref.getLong("workplan_entry", 0), pref
											...
											"planned_time_visit", 0), pref.getString("notes", null), pref.getString("highlights", null),
									pref.getString("next_steps", null), pref.getString("follow_up_committment_date", null), "", 0, 0, "",
									0, pref.getString("end_user_activity_types", null)).execute();
