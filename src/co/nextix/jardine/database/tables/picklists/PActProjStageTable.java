...
public class PActProjStageTable {
	// ===========================================================
	...
	public PActProjStageTable(SQLiteDatabase database, String tableName) {
		mDb = database;
	...
	public boolean isExisting(String name) {
		...
		String MY_QUERY = "SELECT * FROM " + mDatabaseTable + " WHERE "
				+ KEY_ACTIVITY_PROJECT_STAGE_NAME + "='" + name + "'";
		Cursor c = null;
		try {
			c = mDb.rawQuery(MY_QUERY, null);
	...
	public String getNameById(long ID) {
		String result = null;
		String MY_QUERY = "SELECT " + KEY_ACTIVITY_PROJECT_STAGE_NAME
				+ " FROM " + mDatabaseTable + " WHERE "
				+ KEY_ACTIVITY_PROJECT_STAGE_ROWID + "=?";
		Cursor c = null;
		try {
	...
	public boolean update(long id, String name) {
		...
		args.put(KEY_ACTIVITY_PROJECT_STAGE_NAME, name);
