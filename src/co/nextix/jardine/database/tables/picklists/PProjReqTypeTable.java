...
public class PProjReqTypeTable {
	// ===========================================================
	...
	public PProjReqTypeTable(SQLiteDatabase database, String tableName) {
		mDb = database;
	...
	public String getNameById(long ID) {
		String result = null;
		String MY_QUERY = "SELECT " + KEY_PROJECT_REQUIREMENT_TYPE_NAME
				+ " FROM " + mDatabaseTable + " WHERE "
				+ KEY_PROJECT_REQUIREMENT_TYPE_ROWID + "=?";
		Cursor c = null;
		try {
	...
	public boolean update(long id, String name) {
		...
		args.put(KEY_PROJECT_REQUIREMENT_TYPE_NAME, name);
