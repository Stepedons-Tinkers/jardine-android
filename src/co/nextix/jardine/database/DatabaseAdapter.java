...
public class DatabaseAdapter {
	...
	// User
	public final String KEY_USER_ROWID = "_id";
	public final String KEY_USER_NO = "no";
	public final String KEY_USER_USERNAME = "username";
	public final String KEY_USER_PASSWORD = "password";
	public final String KEY_USER_EMAILADDRESS = "email_address";
	public final String KEY_USER_LASTNAME = "last_name";
	public final String KEY_USER_MIDDLENAME = "middle_name";
	public final String KEY_USER_FIRSTNAME = "first_name";
	public final String KEY_USER_LOGGEDIN = "logged_in";
	public final String KEY_USER_STATUS = "status";
	public final String KEY_USER_LASTSYNC = "last_sync";
	public final String KEY_USER_AREA = "area";
	public final String KEY_USER_LOGGEDAREA = "logged_area";
	public final String KEY_USER_CREATEDTIME = "created_time";

	// Activity
	public final String KEY_ACTIVITY_ROWID = "_id";
	public final String KEY_ACTIVITY_NO = "no";
	public final String KEY_ACTIVITY_CRMNO = "crm_no";
	public final String KEY_ACTIVITY_ACTIVITYTYPE = "activity_type";
	public final String KEY_ACTIVITY_CHECKIN = "check_in";
	public final String KEY_ACTIVITY_CHECKOUT = "check_out";
	public final String KEY_ACTIVITY_BUSINESSUNIT = "business_unit";
	public final String KEY_ACTIVITY_CREATEDBY = "created_by";
	public final String KEY_ACTIVITY_LONGITUDE = "longitude";
	public final String KEY_ACTIVITY_LATITUDE = "latitude";
	public final String KEY_ACTIVITY_CREATEDTIME = "created_time";
	public final String KEY_ACTIVITY_MODIFIEDTIME = "modified_time";
	public final String KEY_ACTIVITY_REASONREMARKS = "reason_remarks";
	public final String KEY_ACTIVITY_SMR = "smr";
	public final String KEY_ACTIVITY_ADMINWORKDETAILS = "admin_work_details";
	public final String KEY_ACTIVITY_CUSTOMER = "customer";
	public final String KEY_ACTIVITY_AREA = "area";
	public final String KEY_ACTIVITY_PROVINCE = "province";
	public final String KEY_ACTIVITY_CITY = "city";
	public final String KEY_ACTIVITY_WORKPLANENTRY = "workplan_entry";
	public final String KEY_ACTIVITY_OBJECTIVES = "objectives";
	public final String KEY_ACTIVITY_FIRSTTIMEVISIT = "first_time_visit";
	public final String KEY_ACTIVITY_PLANNEDVISIT = "planned_visit";
	public final String KEY_ACTIVITY_NOTES = "notes";
	public final String KEY_ACTIVITY_HIGHLIGHTS = "highlights";
	public final String KEY_ACTIVITY_NEXTSTEPS = "next_steps";
	public final String KEY_ACTIVITY_FOLLOWUP = "follow_up_commitment_date";
	public final String KEY_ACTIVITY_PROJECTNAME = "project_name";
	public final String KEY_ACTIVITY_PROJECTSTAGE = "project_stage";
	public final String KEY_ACTIVITY_PROJECTCATEGORY = "project_category";
	public final String KEY_ACTIVITY_VENUE = "venue";
	public final String KEY_ACTIVITY_NOOFATTENDEES = "no_of_attendees";
	public final String KEY_ACTIVITY_ENDUSERACTIVITYTYPES = "end_user_activity_types";

	// Activity Type
	public final String KEY_ACTIVITYTYPE_ROWID = "_id";
	public final String KEY_ACTIVITYTYPE_NO = "no";
	// public final String KEY_ACTIVITYTYPE_TYPE = "activity_type";
	public final String KEY_ACTIVITYTYPE_CRMNO = "crm_no";
	public final String KEY_ACTIVITYTYPE_NAME = "name";
	public final String KEY_ACTIVITYTYPE_CATEGORY = "activity_type_categorization";
	public final String KEY_ACTIVITYTYPE_ISACTIVE = "is_active";
	public final String KEY_ACTIVITYTYPE_CREATEDTIME = "created_time";
	public final String KEY_ACTIVITYTYPE_MODIFIEDTIME = "modified_time";
	public final String KEY_ACTIVITYTYPE_USER = "user";

	// Business Unit
	public final String KEY_BUSINESSUNIT_ROWID = "_id";
	public final String KEY_BUSINESSUNIT_NO = "no";
	public final String KEY_BUSINESSUNIT_CRMNO = "crm_no";
	public final String KEY_BUSINESSUNIT_NAME = "business_unit_name";
	public final String KEY_BUSINESSUNIT_CODE = "business_unit_code";
	public final String KEY_BUSINESSUNIT_ISACTIVE = "is_active";
	public final String KEY_BUSINESSUNIT_CREATEDTIME = "created_time";
	public final String KEY_BUSINESSUNIT_MODIFIEDTIME = "modified_time";
	public final String KEY_BUSINESSUNIT_CREATED_BY = "created_by";

	// Competitor Product Stock Check
	public final String KEY_COMPETITORPRODUCTSTOCKCHECK_ROWID = "_id";
	public final String KEY_COMPETITORPRODUCTSTOCKCHECK_NO = "no";
	public final String KEY_COMPETITORPRODUCTSTOCKCHECK_CRMNO = "crm_no";
	public final String KEY_COMPETITORPRODUCTSTOCKCHECK_ACTIVITY = "activity";
	public final String KEY_COMPETITORPRODUCTSTOCKCHECK_COMPETITORPRODUCT = "competitor_product";
	public final String KEY_COMPETITORPRODUCTSTOCKCHECK_STOCKSTATUS = "stock_status";
	public final String KEY_COMPETITORPRODUCTSTOCKCHECK_LOADEDONSHELVES = "loaded_on_shelves";
	public final String KEY_COMPETITORPRODUCTSTOCKCHECK_CREATEDTIME = "created_time";
	public final String KEY_COMPETITORPRODUCTSTOCKCHECK_MODIFIEDTIME = "modified_time";
	public final String KEY_COMPETITORPRODUCTSTOCKCHECK_CREATEDBY = "created_by";

	// Competitor Product
	public final String KEY_COMPETITORPRODUCT_ROWID = "_id";
	public final String KEY_COMPETITORPRODUCT_NO = "no";
	public final String KEY_COMPETITORPRODUCT_CRMNO = "crm_no";
	public final String KEY_COMPETITORPRODUCT_COMPETITOR = "competitor";
	public final String KEY_COMPETITORPRODUCT_PRODUCTBRAND = "product_brand";
	public final String KEY_COMPETITORPRODUCT_PRODUCTDESCRIPTION = "product_description";
	public final String KEY_COMPETITORPRODUCT_PRODUCTSIZE = "product_size";
	public final String KEY_COMPETITORPRODUCT_ISACTIVE = "is_active";
	public final String KEY_COMPETITORPRODUCT_CREATEDTIME = "created_time";
	public final String KEY_COMPETITORPRODUCT_MODIFIEDTIME = "modified_time";
	public final String KEY_COMPETITORPRODUCT_CREATEDBY = "created_by";

	// // Competitor
	// public final String KEY_COMPETITOR_ROWID = "_id";
	// public final String KEY_COMPETITOR_NO = "no";
	// public final String KEY_COMPETITOR_CRMNO = "crm_no";
	// public final String KEY_COMPETITOR_NAME = "competitor_name";
	// public final String KEY_COMPETITOR_ISACTIVE = "is_active";
	// public final String KEY_COMPETITOR_CREATEDTIME = "created_time";
	// public final String KEY_COMPETITOR_MODIFIEDTIME = "modified_time";
	// public final String KEY_COMPETITOR_USER = "user";

	// Customer Contact
	public final String KEY_CUSTOMERCONTACT_ROWID = "_id";
	public final String KEY_CUSTOMERCONTACT_NO = "no";
	public final String KEY_CUSTOMERCONTACT_CRMNO = "crm_no";
	public final String KEY_CUSTOMERCONTACT_FIRSTNAME = "first_name";
	public final String KEY_CUSTOMERCONTACT_LASTNAME = "last_name";
	public final String KEY_CUSTOMERCONTACT_POSITION = "position";
	public final String KEY_CUSTOMERCONTACT_MOBILENO = "mobile_no";
	public final String KEY_CUSTOMERCONTACT_BIRTHDAY = "birthday";
	public final String KEY_CUSTOMERCONTACT_EMAIL = "email_address";
	public final String KEY_CUSTOMERCONTACT_CUSTOMER = "customer";
	public final String KEY_CUSTOMERCONTACT_ISACTIVE = "is_active";
	public final String KEY_CUSTOMERCONTACT_CREATEDTIME = "created_time";
	public final String KEY_CUSTOMERCONTACT_MODIFIEDTIME = "modified_time";
	public final String KEY_CUSTOMERCONTACT_CREATEDBY = "created_by";

	// Customer
	public final String KEY_CUSTOMER_ROWID = "_id";
	public final String KEY_CUSTOMER_NO = "no";
	public final String KEY_CUSTOMER_CRMNO = "crm_no";
	public final String KEY_CUSTOMER_NAME = "customer_name";
	public final String KEY_CUSTOMER_CHAINNAME = "chain_name";
	public final String KEY_CUSTOMER_LANDLINE = "landline";
	public final String KEY_CUSTOMER_FAX = "fax";
	public final String KEY_CUSTOMER_SIZE = "customer_size";
	public final String KEY_CUSTOMER_STREETADDRESS = "street_address";
	public final String KEY_CUSTOMER_RECORDSTATUS = "customer_record_status";
	public final String KEY_CUSTOMER_TYPE = "customer_type";
	public final String KEY_CUSTOMER_BUSINESSUNIT = "business_unit";
	public final String KEY_CUSTOMER_AREA = "area";
	public final String KEY_CUSTOMER_PROVINCE = "province";
	public final String KEY_CUSTOMER_CITYTOWN = "city_town";
	public final String KEY_CUSTOMER_ISACTIVE = "is_active";
	public final String KEY_CUSTOMER_CREATEDTIME = "created_time";
	public final String KEY_CUSTOMER_MODIFIEDTIME = "modified_time";
	public final String KEY_CUSTOMER_CREATED_BY = "created_by";

	// Event Protocol
	public final String KEY_EVENTPROTOCOL_ROWID = "_id";
	public final String KEY_EVENTPROTOCOL_NO = "no";
	public final String KEY_EVENTPROTOCOL_DESCRIPTION = "description";
	public final String KEY_EVENTPROTOCOL_LASTUPDATE = "last_update";
	public final String KEY_EVENTPROTOCOL_TAGS = "tags";
	public final String KEY_EVENTPROTOCOL_EVENTTYPE = "event_type";
	public final String KEY_EVENTPROTOCOL_ISACTIVE = "is_active";
	public final String KEY_EVENTPROTOCOL_CREATEDTIME = "created_time";
	public final String KEY_EVENTPROTOCOL_MODIFIEDTIME = "modified_time";
	public final String KEY_EVENTPROTOCOL_USER = "user";
	public final String KEY_EVENTPROTOCOL_CRMNO = "crm_no";

	// JDI Product Stock Check
	public final String KEY_JDIPRODUCTSTOCKCHECK_ROWID = "_id";
	public final String KEY_JDIPRODUCTSTOCKCHECK_NO = "no";
	public final String KEY_JDIPRODUCTSTOCKCHECK_CRMNO = "crm_no";
	public final String KEY_JDIPRODUCTSTOCKCHECK_ACTIVITY = "activity";
	public final String KEY_JDIPRODUCTSTOCKCHECK_PRODUCTBRAND = "product_brand";
	public final String KEY_JDIPRODUCTSTOCKCHECK_STOCKSTATUS = "stockstatus";
	// public final String KEY_JDIPRODUCTSTOCKCHECK_QUANTITY = "quantity";
	public final String KEY_JDIPRODUCTSTOCKCHECK_LOADEDONSHELVES = "loadedonshelves";
	public final String KEY_JDIPRODUCTSTOCKCHECK_SUPPLIER = "supplier";
	public final String KEY_JDIPRODUCTSTOCKCHECK_OTHERREMARKS = "other_remarks";
	public final String KEY_JDIPRODUCTSTOCKCHECK_CREATEDTIME = "created_time";
	public final String KEY_JDIPRODUCTSTOCKCHECK_MODIFIEDTIME = "modified_time";
	public final String KEY_JDIPRODUCTSTOCKCHECK_CREATEDBY = "created_by";

	// Marketing Intel
	public final String KEY_MARKETINGINTEL_ROWID = "_id";
	public final String KEY_MARKETINGINTEL_NO = "no";
	public final String KEY_MARKETINGINTEL_CRMNO = "crm_no";
	public final String KEY_MARKETINGINTEL_ACTIVITY = "activity";
	// public final String KEY_MARKETINGINTEL_COMPETITOR = "competitor";
	public final String KEY_MARKETINGINTEL_COMPETITORPRODUCT = "competitor_product";
	public final String KEY_MARKETINGINTEL_DETAILS = "details";
	// public final String KEY_MARKETINGINTEL_REMARKS = "remarks";
	public final String KEY_MARKETINGINTEL_CREATEDTIME = "created_time";
	public final String KEY_MARKETINGINTEL_MODIFIEDTIME = "modified_time";
	public final String KEY_MARKETINGINTEL_CREATEDBY = "created_by";

	// Product
	public final String KEY_PRODUCT_ROWID = "_id";
	public final String KEY_PRODUCT_NO = "no";
	public final String KEY_PRODUCT_CRMNO = "crm_no";
	public final String KEY_PRODUCT_NUMBER = "product_number";
	public final String KEY_PRODUCT_BRAND = "product_brand";
	public final String KEY_PRODUCT_DESCRIPTION = "product_description";
	public final String KEY_PRODUCT_PACKSIZE = "pack_size";
	public final String KEY_PRODUCT_BUSINESSUNIT = "business_unit";
	public final String KEY_PRODUCT_ISACTIVE = "is_active";
	public final String KEY_PRODUCT_CREATEDTIME = "created_time";
	public final String KEY_PRODUCT_MODIFIEDTIME = "modified_time";
	public final String KEY_PRODUCT_CREATEDBY = "created_by";

	// Project Requirement
	public final String KEY_PROJECTREQUIREMENTS_ROWID = "_id";
	public final String KEY_PROJECTREQUIREMENTS_NO = "no";
	public final String KEY_PROJECTREQUIREMENTS_CRMNO = "crm_no";
	public final String KEY_PROJECTREQUIREMENTS_ACTIVITY = "activity";
	public final String KEY_PROJECTREQUIREMENTS_TYPE = "project_requirement_type";
	public final String KEY_PROJECTREQUIREMENTS_DATENEEDED = "date_needed";
	public final String KEY_PROJECTREQUIREMENTS_SQUAREMETERS = "square_meters";
	// public final String KEY_PROJECTREQUIREMENTS_PRODUCTSUSED =
	// "products_used";
	public final String KEY_PROJECTREQUIREMENTS_PRODUCTSBRAND = "products_brand";
	public final String KEY_PROJECTREQUIREMENTS_OTHERDETAILS = "other_details";
	public final String KEY_PROJECTREQUIREMENTS_CREATEDTIME = "created_time";
	public final String KEY_PROJECTREQUIREMENTS_MODIFIEDTIME = "modified_time";
	public final String KEY_PROJECTREQUIREMENTS_CREATEDBY = "created_by";

	// SMR
	public final String KEY_SMR_ROWID = "_id";
	public final String KEY_SMR_NO = "no";
	public final String KEY_SMR_CRMNO = "crm_no";
	public final String KEY_SMR_FIRSTNAME = "firstname";
	public final String KEY_SMR_LASTNAME = "lastname";
	// public final String KEY_SMR_REGION = "region";
	public final String KEY_SMR_AREA = "area";
	public final String KEY_SMR_ISACTIVE = "is_active";
	public final String KEY_SMR_BUSINESS_UNIT = "business_unit";
	public final String KEY_SMR_CREATEDTIME = "created_time";
	public final String KEY_SMR_MODIFIEDTIME = "modified_time";
	public final String KEY_SMR_CREATED_BY = "created_by";

	// // SMR Time Card
	// public final String KEY_SMRTIMECARD_ROWID = "_id";
	// public final String KEY_SMRTIMECARD_NO = "no";
	// public final String KEY_SMRTIMECARD_DATE = "date";
	// public final String KEY_SMRTIMECARD_TIMESTAMP = "timestamp";
	// public final String KEY_SMRTIMECARD_ENTRYTYPE = "entry_type";
	// public final String KEY_SMRTIMECARD_CREATEDTIME = "created_time";
	// public final String KEY_SMRTIMECARD_MODIFIEDTIME = "modified_time";
	// public final String KEY_SMRTIMECARD_USER = "user";
	// public final String KEY_SMRTIMECARD_CRMNO = "crm_no";

	// // Supplier
	// public final String KEY_SUPPLIER_ROWID = "_id";
	// public final String KEY_SUPPLIER_NO = "no";
	// public final String KEY_SUPPLIER_NAME = "supplier_name";
	// public final String KEY_SUPPLIER_LANDLINE = "supplier_landline";
	// public final String KEY_SUPPLIER_ADDRESS = "supplier_address";
	// public final String KEY_SUPPLIER_CREDITLINE = "credit_line";
	// public final String KEY_SUPPLIER_CREDITTERM = "credit_term";
	// public final String KEY_SUPPLIER_CONTACTPERSON = "contact_person";
	// public final String KEY_SUPPLIER_ISACTIVE = "is_active";
	// public final String KEY_SUPPLIER_CREATEDTIME = "created_time";
	// public final String KEY_SUPPLIER_MODIFIEDTIME = "modified_time";
	// public final String KEY_SUPPLIER_USER = "user";
	// public final String KEY_SUPPLIER_CRMNO = "crm_no";

	// Workplan Entry
	public final String KEY_WORKPLANENTRY_ROWID = "_id";
	public final String KEY_WORKPLANENTRY_NO = "no";
	public final String KEY_WORKPLANENTRY_CRMNO = "crm_no";
	// public final String KEY_WORKPLANENTRY_CUSTOMER = "customer";
	public final String KEY_WORKPLANENTRY_DATE = "date";
	public final String KEY_WORKPLANENTRY_STATUS = "status";
	public final String KEY_WORKPLANENTRY_AREA = "area";
	public final String KEY_WORKPLANENTRY_PROVINCE = "province";
	public final String KEY_WORKPLANENTRY_CITY = "city";
	public final String KEY_WORKPLANENTRY_ACTIVITYTYPE = "activity_type";
	public final String KEY_WORKPLANENTRY_REMARKS = "remarks";
	public final String KEY_WORKPLANENTRY_WORKPLAN = "workplan";
	public final String KEY_WORKPLANENTRY_ACTIVITYQUANTITY = "activity_quantity";
	public final String KEY_WORKPLANENTRY_BUSINESSUNIT = "business_unit";
	public final String KEY_WORKPLANENTRY_CREATEDTIME = "created_time";
	public final String KEY_WORKPLANENTRY_MODIFIEDTIME = "modified_time";
	public final String KEY_WORKPLANENTRY_CREATEDBY = "created_by";

	// Workplan
	public final String KEY_WORKPLAN_ROWID = "_id";
	public final String KEY_WORKPLAN_NO = "no";
	public final String KEY_WORKPLAN_CRMNO = "crm_no";
	public final String KEY_WORKPLAN_FROMDATE = "from_date";
	public final String KEY_WORKPLAN_TODATE = "to_date";
	// public final String KEY_WORKPLAN_STATUS = "status"; removed
	public final String KEY_WORKPLAN_CREATEDTIME = "created_time";
	public final String KEY_WORKPLAN_MODIFIEDTIME = "modified_time";
	public final String KEY_WORKPLAN_CREATEDBY = "created_by";

	// Marketing Materials
	public final String KEY_MARKETINGMATERIALS_ROWID = "_id";
	public final String KEY_MARKETINGMATERIALS_NO = "no";
	public final String KEY_MARKETINGMATERIALS_CRMNO = "crm_no";
	public final String KEY_MARKETINGMATERIALS_DESCRIPTION = "description";
	public final String KEY_MARKETINGMATERIALS_LASTUPDATE = "last_update";
	public final String KEY_MARKETINGMATERIALS_TAGS = "tags";
	public final String KEY_MARKETINGMATERIALS_BUSINESSUNIT = "business_unit";
	public final String KEY_MARKETINGMATERIALS_ISNEW = "is_new";
	public final String KEY_MARKETINGMATERIALS_ISACTIVE = "is_active";
	public final String KEY_MARKETINGMATERIALS_CREATEDTIME = "created_time";
	public final String KEY_MARKETINGMATERIALS_MODIFIEDTIME = "modified_time";
	public final String KEY_MARKETINGMATERIALS_CREATEDBY = "created_by";

	// JDI Merchandising
	public final String KEY_JDIMERCHANDISING_ROWID = "_id";
	public final String KEY_JDIMERCHANDISING_NO = "no";
	public final String KEY_JDIMERCHANDISING_CRMNO = "crm_no";
	public final String KEY_JDIMERCHANDISING_ACTIVITY = "activity";
	public final String KEY_JDIMERCHANDISING_PRODUCTBRAND = "product_brand";
	public final String KEY_JDIMERCHANDISING_STATUS = "status";
	public final String KEY_JDIMERCHANDISING_CREATEDTIME = "created_time";
	public final String KEY_JDIMERCHANDISING_MODIFIEDTIME = "modified_time";
	public final String KEY_JDIMERCHANDISING_CREATEDBY = "created_by";

	// Documents
	public final String KEY_DOCUMENT_ROWID = "_id";
	public final String KEY_DOCUMENT_NO = "no";
	public final String KEY_DOCUMENT_TITLE = "title";
	public final String KEY_DOCUMENT_MODULENAME = "module_name";
	public final String KEY_DOCUMENT_MODULEID = "module_id";
	public final String KEY_DOCUMENT_FILENAME = "file_name";
	public final String KEY_DOCUMENT_FILETYPE = "file_type";
	public final String KEY_DOCUMENT_FILEPATH = "file_path";
	public final String KEY_DOCUMENT_ISACTIVE = "is_active";
	public final String KEY_DOCUMENT_CREATEDTIME = "created_time";
	public final String KEY_DOCUMENT_MODIFIEDTIME = "modified_time";
	public final String KEY_DOCUMENT_USER = "user";
	public final String KEY_DOCUMENT_CRMNO = "crm_no";

	// Calendar
	public final String KEY_CALENDAR_ROWID = "_id";
	public final String KEY_CALENDAR_ACTIVITYTYPE = "activitytype";
	public final String KEY_CALENDAR_DATESTART = "date_start";
	public final String KEY_CALENDAR_DUEDATE = "due_date";
	public final String KEY_CALENDAR_DESCRIPTION = "description";
	public final String KEY_CALENDAR_SUBJECT = "subject";
	public final String KEY_CALENDAR_TIMESTART = "time_start";
	public final String KEY_CALENDAR_TIMEEND = "time_end";
	public final String KEY_CALENDAR_ACTIVITY = "activity";
	public final String KEY_CALENDAR_CREATEDTIME = "created_time";
	public final String KEY_CALENDAR_MODIFIEDTIME = "modified_time";
	public final String KEY_CALENDAR_USER = "user";

	// Product Focus
	public final String KEY_PRODUCTFOCUS_ROWID = "_id";
	public final String KEY_PRODUCTFOCUS_PRODUCT = "product";
	public final String KEY_PRODUCTFOCUS_ACTIVITY = "activity";

	// Product Supplier
	public final String KEY_PRODUCTSUPPLIER_ROWID = "_id";
	public final String KEY_PRODUCTSUPPLIER_NO = "no";
	public final String KEY_PRODUCTSUPPLIER_CRMNO = "crm_no";
	public final String KEY_PRODUCTSUPPLIER_PRODUCTBRAND = "product_brand";
	public final String KEY_PRODUCTSUPPLIER_SUPPLIER = "supplier";
	public final String KEY_PRODUCTSUPPLIER_OTHERREMARKS = "others_remarks";
	public final String KEY_PRODUCTSUPPLIER_ACTIVITY = "activity";
	public final String KEY_PRODUCTSUPPLIER_CREATEDBY = "created_by";
	public final String KEY_PRODUCTSUPPLIER_CREATEDTIME = "created_time";
	public final String KEY_PRODUCTSUPPLIER_MODIFIEDTIME = "modified_time";

	// Sales Protocol
	public final String KEY_SALESPROTOCOL_ROWID = "_id";
	public final String KEY_SALESPROTOCOL_NO = "no";
	public final String KEY_SALESPROTOCOL_CRMNO = "crm_no";
	public final String KEY_SALESPROTOCOL_BUSINESSUNIT = "business_unit";
	public final String KEY_SALESPROTOCOL_DESCRIPTION = "description";
	public final String KEY_SALESPROTOCOL_LASTUPDATE = "last_update";
	public final String KEY_SALESPROTOCOL_TAGS = "tags";
	public final String KEY_SALESPROTOCOL_PROTOCOLTYPE = "protocol_type";
	public final String KEY_SALESPROTOCOL_ISACTIVE = "is_active";
	public final String KEY_SALESPROTOCOL_CREATEDBY = "created_by";
	public final String KEY_SALESPROTOCOL_CREATEDTIME = "created_time";
	public final String KEY_SALESPROTOCOL_MODIFIEDTIME = "modified_time";

	// Picklists
	public final String KEY_PICKLISTS_ROWID = "_id";
	public final String KEY_PICKLISTS_NAME = "name";

	// // Picklist Activitytype Type
	// public final String KEY_ACTIVITYTYPE_TYPE_ROWID = "_id";
	// public final String KEY_ACTIVITYTYPE_TYPE_NAME = "name";
	// public final String KEY_ACTIVITYTYPE_TYPE_CATEGORY =
	// "activity_category";

	// Location Province
	public final String KEY_PROVINCE_ROWID = "_id";
	public final String KEY_PROVINCE_NAME = "name";
	public final String KEY_PROVINCE_AREA = "area";

	// Location CityTown
	public final String KEY_CITYTOWN_ROWID = "_id";
	public final String KEY_CITYTOWN_NAME = "name";
	public final String KEY_CITYTOWN_PROVINCE = "province";
