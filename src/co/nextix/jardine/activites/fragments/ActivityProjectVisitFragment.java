...
public class ActivityProjectVisitFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		((TextView) rootView.findViewById(R.id.project_name)).setText("");
		if (this.activityRecord != null) {
			((TextView) rootView.findViewById(R.id.project_name)).setText(this.activityRecord.getProjectName());
		}
		...
		if (project_stage != null) {
			...
			((TextView) rootView.findViewById(R.id.project_stage)).setText("");
			if (proStageRec != null) {
				((TextView) rootView.findViewById(R.id.project_stage)).setText(proStageRec.toString());
			}
		}
		...
		if (project_category != null) {
			...
			((TextView) rootView.findViewById(R.id.project_category)).setText("");
			if (proCategoryRec != null) {
				((TextView) rootView.findViewById(R.id.project_category)).setText(proCategoryRec.toString());
			}
		}
