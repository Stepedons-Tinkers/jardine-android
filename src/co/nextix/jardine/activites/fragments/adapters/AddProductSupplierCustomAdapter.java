...
public class AddProductSupplierCustomAdapter extends BaseAdapter implements OnClickListener {
	...
	public AddProductSupplierCustomAdapter(Context a, FragmentActivity act, ArrayList<?> d, Fragment fragment) {
