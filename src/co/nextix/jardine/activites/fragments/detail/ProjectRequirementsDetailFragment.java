...
public class ProjectRequirementsDetailFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		((TextView) myFragmentView.findViewById(R.id.project_requirement_type)).setText(this.activityRecord.getCheckOut());
		((TextView) myFragmentView.findViewById(R.id.date_needed)).setText(String.valueOf(this.activityRecord.getLatitude()));
		((TextView) myFragmentView.findViewById(R.id.square_meters)).setText(String.valueOf(this.activityRecord.getLongitude()));
