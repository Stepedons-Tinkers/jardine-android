...
public class CustomerContactPersonDetailFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		((TextView) myFragmentView.findViewById(R.id.first_name)).setText(this.activityRecord.getCheckIn());
		((TextView) myFragmentView.findViewById(R.id.last_name)).setText(this.activityRecord.getCheckOut());
		((TextView) myFragmentView.findViewById(R.id.position)).setText(String.valueOf(this.activityRecord.getLatitude()));
		((TextView) myFragmentView.findViewById(R.id.mobile_no)).setText(String.valueOf(this.activityRecord.getLongitude()));
