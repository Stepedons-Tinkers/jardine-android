...
public class JDIMerchandisingCheckFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		final View myFragmentView = inflater.inflate(R.layout.fragment_activity_jdi_merchandising_check, container, false);
		((Button) myFragmentView.findViewById(R.id.add_btn_jdi_merchandising_check)).setOnClickListener(new OnClickListener() {
